...
<div class="row">
    <div class="col-lg-12">
        <div class="card mb-4">
            ...
            THÔNG TIN HOÁN CHUYỂN CA TRỰC</h6>
            </div>

			<div style="padding-top: 15px; padding-left:15px;">
            <a href="them_phancong.php" style="padding-top: 15px;"><button type="button" class="btn btn-primary" > Thêm mới </button> </a>
            </div>
            ...
            switch ($row["trangthai"]) {
                case "Đã phân công":
                    echo "<td class='daphancong'>" . $row["trangthai"] . "</td>";
                    break;
                case "Đã duyệt hoán chuyển":
                    echo "<td class='daduyetHD'>" . $row["trangthai"] . "</td>";
                    break;
                case "Phân công":
                    echo "<td class='phancong'>" . $row["trangthai"] . "</td>";
                    break;
                default:
            ...
            echo "<td>" . date('d/m/Y', strtotime($row["ngayduyet"])) . "</td>";
